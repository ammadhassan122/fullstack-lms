...
export default function PricingPage() {
  return (
    <div className="min-h-screen bg-[#09090b] text-white overflow-hidden">
      ...
      {/* Main Content */}
      <main className="relative px-6 lg:px-12 py-12 max-w-7xl mx-auto fade-up">
        {/* Header */}
        ...
        {/* Clerk Pricing Table */}
        <div className="clerk-pricing-wrapper relative z-20 rounded-2xl bg-zinc-900/50 border border-zinc-800 p-6 md:p-10 fade-up">
          <PricingTable
            appearance={{
              elements: {
                pricingTable: {
